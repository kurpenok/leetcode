...
pub fn level_order_bottom(root: Option<Rc<RefCell<TreeNode>>>) -> Vec<Vec<i32>> {
    ...
    depth_keys.sort_by(|a, b| b.cmp(a));
...
mod test {
    ...
    fn test_case_1() {
        assert_eq!(
            level_order_bottom(Some(Rc::new(RefCell::new(TreeNode {
                val: 3,
    ...
    fn test_case_2() {
        assert_eq!(
            level_order_bottom(Some(Rc::new(RefCell::new(TreeNode::new(1))))),
            vec![vec![1]]
        );
    }
    ...
    fn test_case_3() {
        ...
        assert_eq!(level_order_bottom(None), expected_result);
    }
}
